...
**[Setup](#setup) | [Usage](#usage) | [Documentation](#documentation)**
...
```bash
git clone git@github.com:IBM/dgt.git
cd dgt
```
...
```bash
python -m dgt.core --task-paths ./tasks/core/logical_reasoning/causal --restart-generation
```
