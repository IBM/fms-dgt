...
An example can be found [here](https://github.ibm.com/DGT/fms-dgt/tree/main/tasks/core/logical_reasoning/causal/task.yaml)
...
To evaluate the data produced by this databuilder, we recommend ...
...
python -m fms_dgt.core --task-path ./tasks/core/logical_reasoning/causal/task.yaml --restart --num-outputs 10
