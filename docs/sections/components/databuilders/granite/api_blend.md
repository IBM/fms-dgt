...
Ensure you have installed the toml requirements, downloaded `en_core_web_sm`, and downloaded nltk's `averaged_perceptron_tagger_eng`



```bash

pip install ".[api-blend]"
...
python -m fms_dgt.granite --task-path ./tasks/granite/function_calling/api_blend/<subtask>/task.yaml
